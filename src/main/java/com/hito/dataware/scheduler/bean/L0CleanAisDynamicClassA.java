...
import com.hito.dataware.scheduler.annotation.Point;
import lombok.Data;
...
@Table(name = "l0_clean_ais_dynamic_a")
@Data
@Document(indexName = "myidentitydynamic", type = "dynamic")
public class L0CleanAisDynamicClassA extends EsBaseField implements Serializable {
    ...
    public Object transfrom(JSONObject jsonObject, SearchHit hit) {
        L0CleanAisDynamicClassA o = (L0CleanAisDynamicClassA) JSONObject.toBean(jsonObject, L0CleanAisDynamicClassA.class);
        o.insertBase(hit);
        return o;
    }
}